	...
	function getMyData() {
		...
		loadXMLDoc("poll_to_xml.php", function () {
			...
			if (xmlhttp.readyState == 4) {
				...
				var Atext = "React.js: " + Avotes + "<br/>" + (Avotes / totalVotes * 100).toFixed(1) + "%";
				var Btext = "Angular.js: " + Bvotes + "<br/>" + (Bvotes / totalVotes * 100).toFixed(1) + "%";
				var Ctext = "Laravel: " + Cvotes + "<br/>" + (Cvotes / totalVotes * 100).toFixed(1) + "%";
