...
<head>
	...
	<title>Favorite Web Development Framework</title>
...
<body>
	...
	<div id="container">
		<header>
			<h1>What's Your Favorite Web Development Framework?</h1>
		</header>
		   ...
		   ?>   
			...
			<div id="results">
				...
				<div id="optA" class="myopt">
					...
					<img src="images/optA_top.jpg" width="100%">
					</div>
				...
				<div id="optB" class="myopt">
					<div id="optBtop" class="myopttop">
						<img src="images/optB_top.jpg" width="100%">
					</div>
				...
				<div id="optC" class="myopt">
					<div id="optCtop" class="myopttop">
							<img src="images/optC_top.jpg" width="100%">
					</div>
